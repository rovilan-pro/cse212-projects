...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: infinite turns were mishandled
    ...
    // Defect(s) Found: Adding a person midway caused wrong order
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Infinite turns were not handled properly
    ...
    // Defect(s) Found: Infinite negative turns not handled
    ...
    // Defect(s) Found: GetNextPerson threw wrong exception message 
